...
@XmlType(name = "", propOrder = { "presentation", "extent", "coordinate",
		"genericAttributes" })
public class PolyLine extends Curve {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link Presentation }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the coordinate property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the genericAttributes property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
