...
@XmlRootElement(name = "ProcessSignalGeneratingFunction")
public class ProcessSignalGeneratingFunction extends DrawableObjectThatInheritsDirectlyFromPlantItem{
