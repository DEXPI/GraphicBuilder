...
@XmlRootElement(name = "ProcessSignalGeneratingSystemComponent")
public class ProcessSignalGeneratingSystemComponent extends DrawableObjectThatInheritsDirectlyFromPlantItem{
